...
오리엔테이션 안내는 `#journey` 바로 아래, `#tracks`보다 앞에 있는 `#orientation` 섹션입니다.
...
- 오리엔테이션은 신청 후 16주 프로그램을 시작하기 전 진행되는 공식 진입 단계입니다.
- 심리검사 및 사전 확인은 참여자를 평가하거나 낙인찍기 위한 절차가 아니라, 현재 상태와 필요를 이해하고 참여 방식과 필요한 지원을 함께 살펴보기 위한 과정으로 안내합니다.
- 검사 결과와 응답 내용은 프로그램 운영 목적 범위 안에서만 활용되며, 프로그램 종료 후 내부 개인정보 처리 기준에 따라 안전하게 폐기된다는 원칙을 유지합니다.
- 실제 개인정보 수집·이용 동의서 문구와 최종 일치 여부는 추후 확인이 필요합니다.
...
[ ] 신청 안내 폼 및 신청 링크
[ ] 선정 안내 일정
[x] 모집 마감일: 2026년 7월 13일(월)
[x] 오리엔테이션 일자: 2026년 7월 16일(목)
...
[ ] 신청 안내 폼 및 신청 링크 확정
[ ] 선정 안내 일정 확정
[x] 모집 마감일 확정: 2026년 7월 13일(월)
[x] 오리엔테이션 일자 확정: 2026년 7월 16일(목)
[ ] 심리검사 및 사전 확인 문구와 실제 개인정보 수집·이용 동의서 최종 일치 여부 확인
[ ] 디스코드 초대 방식 확정
...
- 참여자 모집은 2026년 7월 13일(월)까지
- 신청 링크는 Typeform으로 연결
- 오리엔테이션은 2026년 7월 16일(목) 진행
- 오리엔테이션에서는 16주 프로그램 전체 안내, 심리검사 및 사전 확인, 1~3주차 필수 온보딩 안내, 나에게 맞는 참여 방식 확인을 진행
- 심리검사 결과와 응답 내용은 프로그램 운영 목적 범위 안에서만 활용하며, 프로그램 종료 후 내부 개인정보 처리 기준에 따라 안전하게 폐기
...
- 확정된 모집 마감일과 오리엔테이션 일자는 단정 톤으로 안내합니다.
- 그 외 내부 확정 전 일정은 “예정” 톤을 유지합니다.
